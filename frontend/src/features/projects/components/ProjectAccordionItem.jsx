    ...
    <Accordion.Item eventKey={project.id} key={project.id}>
      ...
      <Accordion.Body>
        ...
        >
            ...
            <Col md={6}>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    handleProjectChange(project.id, "default_width", e.target.value)
                  }
                  disabled={status.isSaving}
                />
              </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={(e) =>
                handleProjectChange(project.id, "jsonString", e.target.value)
              }
        ...
        <small className="text-muted">
          ID: {project.id} | Создан: {new Date(project.created_at).toLocaleString()} |
